...
def tod():
    ...
    for x in titik:
        ...
        sys.stdout.flush()
        time.sleep(1)
logo = ' \x1b[0;92m FFFF U   U  CCC K  K \x1b[0m\n \x1b[0;91m F    U   U C    K K \x1b[0m || Author > TechQaiser\x1b[0m\n \x1b[0;92m FFF  U   U C    KK\x1b[0m   || Github.com/Red-Mafia\x1b[0m\n  \x1b[0;91mF    U   U C    K K\x1b[0m  v1.91 || Fb > Red-Mafia\x1b[0m\n \x1b[0;92m F     UUU   CCC K  K\x1b[0m v1.91 || youtube > Red-Mafia\x1b[0m'
...
def yayanxd():
    ...
    if kontol in ('open', 'Open', 'OPEN'):
        os.system('xdg-open https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/')
